...
function BasicExample() {
  return (
    <div className="cardWallet work animate__animated animate__backInRight animate__delay-1s">
      <div
        className="img-section d.flex justify-content-center"
        style={{ backgroundImage: `url(${Billete})` }}
      ></div>
      <div className="cardWallet-desc">
        <div className="cardWallet-header">
          <div className="cardWallet-title">BILLETERA</div>
          <div className="cardWallet-menu"></div>
        </div>
